    ...
    >
      ...
      >
        ...
        <p className="text-[13px] leading-relaxed text-secondary-text mb-4">
          Silakan top up sebesar <span className="font-bold text-primary">Rp59.999</span> untuk mengaktifkan model premium Bynara (<span className="font-semibold text-foreground">agnes-2.5-flash</span> & <span className="font-semibold text-foreground">grok-4.5</span>).
        </p>
